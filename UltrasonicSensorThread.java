...
public class UltrasonicSensorThread extends Thread implements Runnable {
  ...
  private static int BUFFER_SIZE=5;                     // use odd number
  private static int DELAY_BEFORE_FIRST_READ=250;       // suggested initial delay before read
  private static int DELAY_BEFORE_SUBSEQUENT_READS=60;  // suggested delay before subsequent reads > 50

  private Team25UltrasonicSensor t25us;
  private double ultrasonicLevel;
  private double[] usLevelBuffer;
  ...
  public double getUltrasonicLevelMedian() {
    ...
    System.arraycopy(usLevelBuffer, 0, sortedUsLevelBuffer, 0, BUFFER_SIZE);
